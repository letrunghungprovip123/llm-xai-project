...
research/python/         Python: dữ liệu, model, SHAP, IR và evidence S0–S5
research/ts/        TypeScript: generation, canonicalization, contract và claims
...
Cài Python environment theo tài liệu trong `research/python/`.
...
```bash
npx tsx --test tests/research/ts/<test-file>.test.ts
```
