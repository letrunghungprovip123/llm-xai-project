...
import { sha256 } from "../../../research/ts/common/utils";
import {
  locateNumericSource,
} from "../../../research/ts/claim_extraction/claimPostprocessor";
import {
  assertCountFactCompleteness,
  extractCountFacts,
  finalizeGenerationClaims,
  isPolicyAbsenceSlot,
} from "../../../research/ts/claim_finalization/claimFinalizationRules";
import {
  validateStoredRawResponseHash,
} from "../../../research/ts/claim_finalization/claimFinalizer";
import type {
  GenerationTextDocument,
} from "../../../research/ts/claim_extraction/generationTextAdapter";
...
test("provider canonicalization resolves explicit high-risk prediction", async () => {
  const { validateAndNormalizeClaimPayload } = await import(
    "../../../research/ts/claim_extraction/atomicClaimSchema"
  );
