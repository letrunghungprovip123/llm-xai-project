...
from research.python.common.dataframes import (
    count_infinite_values,
    replace_infinite_with_nan,
)
from research.python.common.hashing import sha256_file
from research.python.feature_engineering.feature_groups import (
    safe_divide,
    validate_feature_group,
)
from research.python.feature_matrix.matrix_registry import validate_final_matrix
...
class ImportBoundaryTests(unittest.TestCase):
    def test_active_r3_modules_do_not_create_directories_at_import(self) -> None:
        module_paths = [
            REPOSITORY_ROOT / "research/python/data_audit/pipeline.py",
            REPOSITORY_ROOT / "research/python/target_audit/pipeline.py",
            REPOSITORY_ROOT / "research/python/feature_engineering/feature_groups.py",
            REPOSITORY_ROOT / "research/python/feature_matrix/matrix_registry.py",
        ]
