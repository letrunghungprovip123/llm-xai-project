...
from research.python.data_split.splitter import (
    build_split_stats,
    check_target_and_id_leakage,
)
from research.python.preprocessing.transforms import (
...
class TrainOnlyPreprocessingTests(unittest.TestCase):
    def test_numeric_imputer_and_scaler_fit_only_train(self) -> None:
        ...
        with (
            patch(
                "research.python.preprocessing.transforms.create_simple_imputer",
                return_value=imputer,
            ),
            patch(
                "research.python.preprocessing.transforms.create_standard_scaler",
                return_value=scaler,
            ),
        ):
