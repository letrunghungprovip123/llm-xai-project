...
from .loaders import XAIInputs
from .model_capabilities import resolve_xai_explainer_plan
...
def compute_local_shap_values(
    *,
    ...
    selected_cases: pd.DataFrame,
    background_sample_size: int | None = None,
    prefer_tree_explainer: bool | None = None,
) -> LocalShapResult:
    warnings: list[str] = []

    if prefer_tree_explainer is None:
