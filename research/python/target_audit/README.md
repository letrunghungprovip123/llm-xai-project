...
Chạy bằng `npm run research -- ml:target-audit`. Module fail khi raw input hoặc invariant target không hợp lệ; không tự sửa dữ liệu. Regression nằm trong `tests/research/python/`.
