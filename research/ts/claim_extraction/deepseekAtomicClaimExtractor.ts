...
import extractionPrompt from "../../../config/research/ts-validation/claim_extraction_prompt_v3.json";
import type {
  AtomicClaimExtractionPayload,
  ClaimExtractionRawResponse,
} from "../../../contracts/validation-claims";
import { sha256 } from "../common/utils";
import { postJsonWithRetry } from "../narrative/runners/httpHelpers";
import {
...
export const DEEPSEEK_ATOMIC_CLAIM_EXTRACTOR_DEFAULTS: Readonly<DeepSeekAtomicClaimExtractorConfig> = Object.freeze({
...
export function getDefaultDeepSeekAtomicClaimExtractorConfig(): DeepSeekAtomicClaimExtractorConfig {
  const defaults = DEEPSEEK_ATOMIC_CLAIM_EXTRACTOR_DEFAULTS;
  return {
