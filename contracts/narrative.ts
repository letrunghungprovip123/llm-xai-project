...
export interface TargetSemanticsPayload {
  ...
  source_positive_value?: unknown;
  source_negative_value?: unknown;
}

export interface DatasetIdentityPayload {
  dataset_id: string;
...
export interface ExperimentIdentityPayload {
  experiment_id: string;
  run_id?: string;
  source_common_ml_run_id?: string;
}

export interface CaseIdentityPayload {
  case_id: string;
  source_entity_id?: string | number | null;
  entity_type?: string;
...
export interface PromptPayload {
  ...
  target_semantics?: TargetSemanticsPayload;
...
export interface EvidencePackage {
  ...
  experiment?: ExperimentIdentityPayload;
  case?: CaseIdentityPayload;
  target_semantics?: TargetSemanticsPayload;
...
export interface DatasetContextSnapshot {
  dataset_id: string;
...
export interface GenerationRecord {
  ...
  dataset_context?: DatasetContextSnapshot;
  target_semantics?: TargetSemanticsPayload;
